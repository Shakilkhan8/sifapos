...
class PosCacheDatabase(models.Model):
    ...
    def get_modifiers_backend_all_models(self, model_values, config_id=None):
        _logger.info('get_modifiers_backend_all_models() started')
        results = {}
        ...
        _logger.info('get_modifiers_backend_all_models() stop')
        return results
    ...
    def installing_datas(self, model_name, min_id, max_id):
        ...
        if logs:
            ...
            log_obj.create(vals)
        self.env.cr.commit()
        _logger.info('installing_datas Done')
        return datas
    ...
    def remove_record(self, model, record_id):
        _logger.info('remove_record() model %s with id %s' % (model, record_id))
