...
class StockQuant(models.Model):
    ...
    def write(self, vals):
        ...
        if context.get('pos_coming', None):
            for quant in self:
...
class StockQuantQueue(models.Model):
    ...
    product_id = fields.Many2one('product.product', 'Product Variant', readonly=1)
    quant_id = fields.Integer('Quant ID', required=1, readonly=1)
    datas = fields.Text('Datas', required=1, readonly=1)
