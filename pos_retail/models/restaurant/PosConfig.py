...
class PosConfig(models.Model):
    ...
    screen_type = fields.Selection([
        ('waiter', 'Waiter/Cashier Level'),
        ('kitchen', 'Kitchen Order Tickets (KOT) Level'),
    ],
        string='Screen Type Session',
        default='waiter',
        help='If set waiter: default screen is Floor Tables Screen\n'
             'If set kitchen: default screen is Kitchen Screen'
    )
