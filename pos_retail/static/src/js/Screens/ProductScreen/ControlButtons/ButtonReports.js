odoo.define('pos_retail.ButtonReports', function (require) {
    'use strict';
    ...
    class ButtonReports extends PosComponent {
        constructor() {
            super(...arguments);
        ...
        async onClick() {
            ...
            let {confirmed, payload: report} = await this.showPopup('SelectionPopup', {
                title: this.env._t('Please select one Report'),
                list: list_report,
            });
    ...
    ButtonReports.template = 'ButtonReports';

    ProductScreen.addControlButton({
        component: ButtonReports,
        condition: function () {
            return (this.env.pos.config.report_product_summary || this.env.pos.config.report_order_summary || this.env.pos.config.report_payment_summary || this.env.pos.config.report_sale_summary)
        },
    });

    Registries.Component.add(ButtonReports);
